...
class SelfIntroductionAnalyzer:
    ...
    def analyze(self, introduction, method):
        if method == 'improved_prompt':
            return self.improved_prompt(introduction)
        elif method == 'step_by_step_prompt':
            return self.step_by_step_prompt(introduction)
        elif method == 'example_prompt':
            return self.example_prompt(introduction)
        elif method == 'constrained_prompt':
            return self.constrained_prompt(introduction)
        else:
...
class SelfIntroductionWriter:
    ...
    def write(self, prompt, method):
        if method == 'improved_prompt':
            return self.improved_prompt(prompt)
        elif method == 'step_by_step_prompt':
            return self.step_by_step_prompt(prompt)
        elif method == 'example_prompt':
            return self.example_prompt(prompt)
        elif method == 'constrained_prompt':
            return self.constrained_prompt(prompt)
        else:
            return 'Error: Invalid method'
...
class PromptOptimizerApp:
    ...
    def write_route(self):
        ...
        method = data.get('method', 'step_by_step_prompt')
