    ...
    actionBtn.addEventListener('click', () => {
        ...
        .then(data => {
            ...
            if (currentAction === 'generate') {
                resultText = `Generated Response: ${data.answer}`;
            } else if (currentAction === 'analyze') {
                resultText = `Analysis Result: ${data.analysis}`;
            } else if (currentAction === 'plagiarism_check') {
                resultText = `Plagiarism Report: ${data.plagiarism_report}`;
            } else if (currentAction === 'spell_check') {
                resultText = `Spell Check Report: ${data.spell_check_report}`;
            }
