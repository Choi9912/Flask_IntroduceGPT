...
class InterviewQuestionGenerator:
    ...
    def generate_questions(self, job_description):
        ...
        results = {method.__name__: method(job_description) for method in methods}
        return results
...
class PromptOptimizerApp:
    ...
    def generate(self):
        ...
        answer = self.writer.write(question)
    ...
    def write_route(self):
        ...
        writing = self.writer.write(prompt)
    ...
    def generate_interview_questions_route(self):
        ...
        questions = self.interview_question_generator.generate_questions(job_description)
